/**
 * Banner upload helper. Decodes a base64 string and stores it in
 * StorageBucket at `banners/{userId}/{pageId}/v{n}.png`. The caller
 ...
 */
async function uploadBanner({ userId, pageId, version, base64 }) {
  ...
  const key = `banners/${userId}/${pageId}/v${version}.png`;
